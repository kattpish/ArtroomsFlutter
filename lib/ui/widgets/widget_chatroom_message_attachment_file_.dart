...
class ChatroomMessageAttachmentFile extends StatelessWidget {
  final State state;
  final DataMessage message;
  final int screenWidth;

  const ChatroomMessageAttachmentFile(
      {super.key, required this.state, required this.message, required this.screenWidth});
              ...
              child: Visibility(
                ...
                child: Container(
                  constraints: BoxConstraints(
                      maxWidth: screenWidth * 0.55, minHeight: 60),
