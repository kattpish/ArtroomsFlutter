...
class ChatroomMessageAttachmentPhoto extends StatelessWidget {
  final BuildContext context;
  final DataMessage message;
  final List<DataMessage> listMessages;
  final double screenWidth;
  const ChatroomMessageAttachmentPhoto({super.key, required this.context, required this.message, required this.listMessages, required this.screenWidth});
